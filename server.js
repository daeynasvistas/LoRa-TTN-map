...
const config = {
    ...
    title: 'IPG - Redes de Sensores MCM 2019',
    dataMapping: {
        temperature: {
            ...
            data: payload => payload.payload_fields.Temperatura
        },
        humidity: {
            graphTitle: 'Humidade',
            yAxisLabel: 'Humidade (%)',
            ...
            maxY: 50,
            numberOfEvents: 30, // no. of events we send to the client
            data: payload => payload.payload_fields.Humidade
        },  
        lux: {
            graphTitle: 'Lux',
            yAxisLabel: 'Lux (lux)',
            ...
            maxY: 10,
            numberOfEvents: 30, // no. of events we send to the client
            data: payload => payload.payload_fields.Luminosidade
        },        
        // want more properties? just add more objects here
    },
    mapCenter: {        
        lat: 40.771888732910156,
        lng: -7.353153228759766
    }
};
...
app.get('/', function (req, res, next) {
    let d = Object.keys(devices).map(k => {
        ...
        let o = {
            ...
            lat: 40.771888732910156,
            lng: -7.353153228759766,
            //lat: payload => payload.payload_fields.latitude,
            //lng: payload => payload.payload_fields.longitude,
          //  lat: devices[k].lat,
          //  lng: devices[k].lng,
        };
